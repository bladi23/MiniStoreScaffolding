...
namespace MiniStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderDate,Total,CustomerId,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderDate,Total,CustomerId,Status")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
